...
def main(event):
    futures = []
    actions = ['FINRA-marketdata', 'FINRA-trddate', 'FINRA-volume', 'FINRA-side', 'FINRA-lastpx']
    parallel = 4
    ...
    result = session.post('https://222.20.94.67/api/v1/namespaces/_/actions/FINRA-marginBalance',
                          params={'blocking': True, 'result': False}, auth=(
            '23bc46b1-71f6-4ed5-8c54-816aa4f8c502',
