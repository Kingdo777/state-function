...
#ifndef STATEFUNCTION_KVBUCKET_H
#define STATEFUNCTION_KVBUCKET_H
...
typedef struct {
    ...
    std::string name;
    size_t size;
    std::shared_ptr<df::dataStruct::KV_Store::StateFunctionKVStoreBucket> bucket;
} Bucket;
...
static PyTypeObject Bucket_Type = {
        ...
        PyDoc_STR("StateFunction KV Store Bucket"),         /* tp_doc */
        nullptr,                                           /* tp_traverse */
        nullptr,                                           /* tp_clear */
...
#endif //STATEFUNCTION_KVBUCKET_H
