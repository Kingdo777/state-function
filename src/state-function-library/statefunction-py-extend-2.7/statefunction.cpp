...
initstatefunction(void) {
    ...
    m = Py_InitModule("statefunction", StateFunctionMethods);
    if (m == nullptr)
        return;
    ...
    char statefunction_error[] = "statefunction.error";
    StateFunctionError = PyErr_NewException(statefunction_error, nullptr, nullptr);
