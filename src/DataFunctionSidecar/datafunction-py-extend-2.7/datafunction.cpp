...
extern "C" {
PyMODINIT_FUNC
initdatafunction(void) {
    PyObject *m;

    m = Py_InitModule("datafunction", DataFunctionMethods);
    if (m == nullptr)
        return;
    ...
    char datafunction_error[] = "datafunction.error";
    DataFunctionError = PyErr_NewException(datafunction_error, nullptr, nullptr);
